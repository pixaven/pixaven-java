...
import com.pixaven.support.BaseRequest;
import com.pixaven.support.Json;
import com.pixaven.support.io.FileSource;
import com.pixaven.support.io.Streams;

public class Pixaven {
    private static URI baseUrl = URI.create("https://api.pixaven.com/");

    static void baseUrl(URI baseUrl) {
        Pixaven.baseUrl = baseUrl;
    }
    ...
    public Pixaven(final String apiKey) {
