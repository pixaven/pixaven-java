...
public abstract class BaseRequest<T extends Operations> extends BaseOperations<T> {
    ...
    public com.pixaven.Response toJson() {
        try {
    ...
    public ByteSourceResponse toBuffer() {
        try {
            ...
            final okhttp3.Request request = new Request.Builder()
                                                .url(url())
                                                .addHeader("X-Pixaven-Binary", "true")
                                                .post(body())
                                                .build();
    ...
    public com.pixaven.Response toFile(String output) throws IOException {
        return toFile(Paths.get(output));
    }

    public com.pixaven.Response toFile(Path output) throws IOException {
